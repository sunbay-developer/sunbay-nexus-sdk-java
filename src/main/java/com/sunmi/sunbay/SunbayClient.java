package com.sunmi.sunbay;

import com.sunmi.sunbay.client.HttpClient;
import com.sunmi.sunbay.constant.ApiConstants;
import com.sunmi.sunbay.exception.SunbayBusinessException;
import com.sunmi.sunbay.model.request.*;
import com.sunmi.sunbay.model.response.*;
 ...
 * @since 2025-12-10
 */
public class SunbayClient implements AutoCloseable {
    ...
    private SunbayClient(Builder builder) {
